...
let opcao = Number(prompt("Digite o valor da atividade entre 1 e 8 ou o desafio(9):"))
...
switch(opcao){
    ...
    const UltimoARRAY = ["suco","refrigerante","agua","whisky"]
    console.log("ESSE É MEU ULTIMO ITEM DO ARRAY",UltimoARRAY.length -1)
    break;
    case 9:
     ...
     //if(arrayUltimo.length > 3 && arrayUltimo.length [1] > 0){
